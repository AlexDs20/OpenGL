...
int main(int argc, char** argv)
{
    ...
    Shader blockShader("../projects/15-MultipleLights/resources/shaders/object_vertex.vs", \
            "../projects/15-MultipleLights/resources/shaders/object_fragment.fs");

    Shader lightShader("../projects/15-MultipleLights/resources/shaders/light_cube.vs", \
            "../projects/15-MultipleLights/resources/shaders/light_cube.fs");
    ...
    unsigned char *data = stbi_load("../projects/15-MultipleLights/resources/container2.png",
            &width,
            &height,
            &n_channels,
            0);
    ...
    data = stbi_load("../projects/15-MultipleLights/resources/container2_specular.png",
            &width,
            &height,
            &n_channels,
            0);
