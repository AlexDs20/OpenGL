...
Mesh Model::processMesh(aiMesh* mesh, const aiScene* scene){
    ...
    for (unsigned int i = 0; i < mesh->mNumVertices; ++i)
    {
        ...
        // process vertex pos, normal and texture
        glm::vec3 vec;
        ...
        // textures, Assimp support up to 8 texture coordinates, here only use 1, check if it exists
    ...
    // process indices, are stored in the faces (i.e. triangle primitives)
