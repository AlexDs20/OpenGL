...
int main(int argc, char** argv)
{
    ...
    Shader blockShader("../projects/10-Colors/resources/shaders/vertex.vs", \
            "../projects/10-Colors/resources/shaders/fragment.fs");

    Shader lightShader("../projects/10-Colors/resources/shaders/light_cube.vs", \
            "../projects/10-Colors/resources/shaders/light_cube.fs");
